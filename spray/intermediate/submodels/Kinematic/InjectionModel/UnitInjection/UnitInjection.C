...
Foam::label Foam::UnitInjection<CloudType>::parcelsToInject
(
    const scalar time0,
    const scalar time1
) const
...
template<class CloudType>
Foam::scalar Foam::UnitInjection<CloudType>::volumeToInject
(
    const scalar time0,
    const scalar time1
) const
...
template<class CloudType>
bool Foam::UnitInjection<CloudType>::active() const
{
    return true;
}
...
template<class CloudType>
Foam::scalar Foam::UnitInjection<CloudType>::timeEnd() const
{
...
template<class CloudType>
void Foam::UnitInjection<CloudType>::setPositionAndCell
(
    const label,
    const label,
    const scalar,
...
template<class CloudType>
void Foam::UnitInjection<CloudType>::setProperties
(
    const label parcelI,
    const label,
    const scalar time,
...
template<class CloudType>
bool Foam::UnitInjection<CloudType>::fullyDescribed() const
{
    return false;
}
...
template<class CloudType>
bool Foam::UnitInjection<CloudType>::validInjection(const label)
{
    return true;
}
