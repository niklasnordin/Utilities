...
//------------------------------------CH -----------------------------------//
		  ...
		  //                    );
		    ...
		    vector injPos = injectionPosition;
                    injectionPosition += injection().injDist(i) * U / mag(U);
//--------------------------------END----------------------------------///--------------------------------END----------------------------------//
                    label injectorCell = mesh_.findCell(injectionPosition);

//		    injCell_[injectorCell] = 1.0;

		    scalar rad = sqrt(injectionPosition[0]*injectionPosition[0]+
				      injectionPosition[1]*injectionPosition[1]);
		    scalar axi = injectionPosition[2];
