...
#include "myORourkeCollisionModel.H"
...
defineTypeNameAndDebug(myORourkeCollisionModel, 0);
...
myORourkeCollisionModel::myORourkeCollisionModel
(
...
void myORourkeCollisionModel::collideParcels(const scalar dt) const
{
